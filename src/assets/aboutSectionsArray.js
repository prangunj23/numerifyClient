...
const aboutSectionsArray = [
    ...
    "Embeddings API, we were able to gather the vector representation of the transcripts of Youtube's math-related " + 
    "content. For now, the algorithm searches through the content of the Professor Leonard youtube channel with over 1,200 " +
    "videos. Since it was designed to be scalable, we plan to support searching through even more channels soon to provide " +
    "an even wider range of educational math content. We have combined this search engine with a roadmap to indicate which " +
    "topics should be learned next and a calculator to help solve problems encountered along the way.",
